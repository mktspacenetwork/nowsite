...
const AreaInternaPage: React.FC = () => {
    ...
    const products = [
        { icon: 'videocam', title: t('areaInternaPage.products.p1.title'), description: t('areaInternaPage.products.p1.description'), imgSrc: '/images/cameradealtaresolucao.jpeg' },
        { icon: 'psychology', title: t('areaInternaPage.products.p2.title'), description: t('areaInternaPage.products.p2.description'), imgSrc: '/images/analisedecomportamento.jpeg' },
        { icon: 'event_available', title: t('areaInternaPage.products.p3.title'), description: t('areaInternaPage.products.p3.description'), imgSrc: '/images/app_now_.jpg' },
        { icon: 'sensors', title: t('areaInternaPage.products.p4.title'), description: t('areaInternaPage.products.p4.description'), imgSrc: '/images/gassensor.jpg' },
    ];
