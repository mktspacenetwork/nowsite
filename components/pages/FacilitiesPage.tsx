...
const FacilitiesPage: React.FC = () => {
    ...
    const products = [
        { icon: 'wifi', title: t('facilitiesPage.products.p1.title'), description: t('facilitiesPage.products.p1.description'), imgSrc: '/images/wifi6.png' },
        { icon: 'settings_ethernet', title: t('facilitiesPage.products.p2.title'), description: t('facilitiesPage.products.p2.description'), imgSrc: '/images/switches.jpg' },
        { icon: 'build', title: t('facilitiesPage.products.p3.title'), description: t('facilitiesPage.products.p3.description'), imgSrc: '/images/manutencaoelevador.jpg' },
