        ...
        <section ref={sectionRef} className="bg-white dark:bg-background-dark py-24">
            <div className="container mx-auto px-6 text-center">
                <div className={`max-w-3xl mx-auto mb-20 transition-all duration-700 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <p className="text-primary font-semibold tracking-widest text-sm mb-4">{t('about.tagline')}</p>
                    <h2 className="text-4xl md:text-5xl font-bold text-text-light-primary dark:text-text-dark-primary mb-6">{t('about.title')}</h2>
                    <p className="text-text-light-secondary dark:text-text-dark-secondary text-lg">{t('about.description')}</p>
                </div>
                ...
                >
                    <p className="text-primary font-semibold tracking-widest text-sm mb-8">{t('about.partnersTagline')}</p>
