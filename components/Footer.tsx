...
const Footer: React.FC<FooterProps> = ({ setCurrentPage }) => {
    ...
    const socialLinks = [
        { 
            href: "#", 
            label: "Facebook",
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" /></svg>
        },
        { 
            href: "#", 
            label: "Instagram",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-12">
                    ...
                    <div className="space-y-4 text-sm col-span-1 md:col-span-2 lg:col-span-1">
                        ...
                        <div className="flex items-start space-x-2">
                            ...
                            <p>Rua Antônio Nápoli, 229<br/>Parada São Paulo - SP<br/>02987-030</p>
                        </div>
                    </div>
                </div>
                <div className="border-t border-gray-700 mt-12 pt-8 flex justify-center text-center text-sm">
                    <p>© Now Soluções | Todos os direitos reservados | 2025</p>
                </div>
            </div>
        </footer>
    );
